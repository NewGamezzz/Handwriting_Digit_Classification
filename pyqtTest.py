...
class Window(QMainWindow):
    def __init__(self):
        ...
        predict = QAction(QIcon(), "Predict", self)
        predict.setShortcut("Ctrl+X")
        fileMenu.addAction(predict)
        predict.triggered.connect(self.predict_class)
        ...
        thirtypxAction = QAction(QIcon(""), "30px", self)
        brushSize.addAction(thirtypxAction)
        thirtypxAction.triggered.connect(self.thirtyPixel)

        ninepxAction = QAction(QIcon("icons/thirtypx.png"), "9px", self)
